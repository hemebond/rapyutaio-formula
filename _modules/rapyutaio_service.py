...
def __virtual__():
    ...
    try:
        ...
        return (
            False,
            "The rapyutaio execution module failed to load. Check the "
            "proxy key in pillar.",
        )

    return (
        False,
        "The rapyutaio execution module failed to load: only works on a "
        "rapyutaio proxy minion.",
    )
...
def get_all():
    ...
    """
    proxy_fn = "rapyutaio.service_list"
...
def start(name, sig=None):
    ...
    proxy_fn = "rapyutaio.service_start"
...
def stop(name, sig=None):
    ...
    """
    proxy_fn = "rapyutaio.service_stop"
    return __proxy__[proxy_fn](name)
...
def restart(name, sig=None):
    ...
    proxy_fn = "rapyutaio.service_restart"
    return __proxy__[proxy_fn](name)
...
def status(name, sig=None):
    ...
    proxy_fn = "rapyutaio.service_status"
